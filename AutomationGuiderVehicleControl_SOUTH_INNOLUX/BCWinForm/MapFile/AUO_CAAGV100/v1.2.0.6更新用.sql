...
GO
ALTER TABLE [dbo].[ACMD_OHTC] ALTER COLUMN [VH_ID] CHAR (8) NOT NULL;
...
GO
ALTER TABLE [dbo].[AMCSREPORTQUEUE] ALTER COLUMN [STREAMFUNCTION_NAME] VARCHAR (60) NOT NULL;

ALTER TABLE [dbo].[AMCSREPORTQUEUE] ALTER COLUMN [VEHICLE_ID] CHAR (8) NULL;
...
GO
ALTER TABLE [dbo].[ASYSEXCUTEQUALITY] ALTER COLUMN [VH_ID] CHAR (8) NULL;
