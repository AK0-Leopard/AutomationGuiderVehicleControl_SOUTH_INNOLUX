    ...
    public partial class uctlAddress : UserControl
    {
        ...
        private void buildLable()
        {
            try
            {
                ...
                int loaction_y = 0;
                if (this.m_iLocY > 300)
                    loaction_y = this.m_iLocY + (this.Height);
                else
                    loaction_y = this.m_iLocY - (this.Height) + 20;
                if (this.p_Address == "10003" || this.p_Address == "10008")
                { loacation_x = loacation_x + 35; }

                lbl_AdrID = new Label();
                //lbl_AdrID.Text = m_sAddress;
                lbl_AdrID.Text = str_Map_Add_Info == null ? "" : str_Map_Add_Info.POINT_ID;
                lbl_AdrID.Font = new System.Drawing.Font("Arial", 14F);
        ...
        private void uctlAddress_Click(object sender, EventArgs e)
        {
            ...
            Uctl_Map.ohtc_Form.setAdrCombobox(str_Map_Add_Info);
        }
