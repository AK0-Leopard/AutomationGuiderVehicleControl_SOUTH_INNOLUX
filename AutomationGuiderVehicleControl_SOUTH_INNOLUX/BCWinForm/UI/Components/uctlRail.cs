...
namespace com.mirle.ibg3k0.bc.winform.UI.Components
{
    public partial class uctlRail : UserControl
    {
        ...
        private string m_sSectionSpeed;
        ...
        public string p_SectionSpeed
        {
            get { return (m_sSectionSpeed); }
            set
            {
                m_sSectionSpeed = value;
                _SetRailToolTip();
            }
        }
        ...
        private void _SetRailToolTip()
        {
            ...
            this.ToolTip.SetToolTip(this,
                        ...
                        "Speed : " + /*this.m_iRailWidth.ToString() + ", " + */this.m_sSectionSpeed + " mm/min" + "\r\n"
...
#pragma warning restore CS0414 // 已指派欄位 'GroupRails.vehicleInterval'，但從未使用過其值。
        ...
        public GroupRails(string section_id, double real_sec_distance, double speed, E_RAIL_DIR rail_dir, string seg_num, E_RAIL_DIR seg_dir)
        {
        ...
        public void DecisionFirstAndLastPoint(bool isfirst)
        {
            ...
            if (isfirst)
            {
                foreach (var rail in uctlRails)
                {
                    ...
                    rail.Key.p_SectionSpeed = Speed.ToString();
