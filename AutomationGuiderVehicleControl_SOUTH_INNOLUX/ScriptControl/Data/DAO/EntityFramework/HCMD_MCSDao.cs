...
namespace com.mirle.ibg3k0.sc.Data.DAO.EntityFramework
{
    public class HCMD_MCSDao
    {
        ...
        public List<HCMD_MCS> loadByStartTimeEndTime(DBConnection_EF con, DateTime startTime, DateTime finishTime)
        {
            var query = from cmd in con.HCMD_MCS
                        where cmd.CMD_START_TIME > startTime && (cmd.CMD_FINISH_TIME != null && cmd.CMD_FINISH_TIME < finishTime)
