...
namespace com.mirle.ibg3k0.sc.Data.DAO
{
    public class ParkZoneDetailDao
    {
        ...
        public APARKZONEDETAIL getByVehicleID(DBConnection_EF con, string vh_id)
        {
            var query = from obj in con.APARKZONEDETAIL
        ...
        public List<APARKZONEDETAIL> loadAllParkDetailByVeID(DBConnection_EF con, string vh_id)
        {
            List<APARKZONEDETAIL> details = null;
            var query = from detail in con.APARKZONEDETAIL
                        where detail.CAR_ID == vh_id.Trim()
                        select detail;
            details = query.ToList();
            return details;
        }
