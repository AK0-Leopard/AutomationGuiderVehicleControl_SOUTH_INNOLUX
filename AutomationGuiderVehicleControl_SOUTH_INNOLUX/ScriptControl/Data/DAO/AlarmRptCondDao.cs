...
namespace com.mirle.ibg3k0.sc.Data.DAO
{
    ...
    public class AlarmRptCondDao : DaoBase
    {
        ...
        public List<ALARMRPTCOND> loadRptCond(DBConnection_EF conn)
        {
        ...
        public List<ALARMRPTCOND> loadRptCond(DBConnection_EF conn,bool is_enable)
        {
            ...
            {
                var query = from rptCond in conn.ALARMRPTCOND
                            where rptCond.ENABLE_FLG == (is_enable ? SCAppConstants.YES_FLAG : SCAppConstants.NO_FLAG)
                            select rptCond;
                cond = query.ToList();
