...
namespace com.mirle.ibg3k0.sc.Data.SECS.SouthInnoluxFactory4
{
    ...
    public class S2F30 : SXFY
    {
        ...
        public class ECITEM : SXFY
        {
            ...
            [SecsElement(Index = 1, Type = SecsElement.SecsElementType.TYPE_4_BYTE_UNSIGNED_INTEGER, Length = 1)]//修改Type為TYPE_2_BYTE_UNSIGNED_INTEGER,修改長度為1 MarkChou 20190315
            public string ECID;
            /// <summary>
            /// The ecname
            /// </summary>
