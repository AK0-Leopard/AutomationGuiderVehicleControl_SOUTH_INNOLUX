...
namespace com.mirle.ibg3k0.sc.BLL
{
    ...
    public class EventBLL
    {
        ...
        /// </summary>
        protected EventRptCondDao eventRptCondDao = null;
        ...
        /// <param name="isEnable">The is enable.</param>
        public virtual bool enableEventReport(string ceid, Boolean isEnable)
        {
            bool isSuccess = true;
            DBConnection_EF conn = null;
            try
        ...
        public virtual List<AEVENTRPTCOND> LoadAllCEID()
        {
            DBConnection_EF conn = null;
        ...
        public virtual List<AEVENTRPTCOND> LoadEnabledCEID()
        {
            DBConnection_EF conn = null;
            List<AEVENTRPTCOND> condList = null;
            try
