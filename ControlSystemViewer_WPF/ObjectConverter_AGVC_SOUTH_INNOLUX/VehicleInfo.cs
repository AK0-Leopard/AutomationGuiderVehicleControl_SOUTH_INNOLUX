...
namespace ObjectConverter_AGVC_SOUTH_INNOLUX
{
    ...
    {
        private readonly string ns = "ObjectConverter_AGVC_SOUTH_INNOLUX" + ".VehicleInfo";
        ...
        public bool SetVVEHICLE(ref ViewerObject.VVEHICLE vh, object vh_info_obj, out string result)
        {
            ...
            try
            {
                ...
                _doing = "InstallStatus";
                vh.INSTALL_STATUS = ViewerObject.VVEHICLE_Def.GetIntallStatus(vh_info.ISINSTALL);
                _doing = "ChargeStatus";
                vh.IS_CHARGING = vh_info.ChargeStatus == VhChargeStatus.ChargeStatusCharging;
