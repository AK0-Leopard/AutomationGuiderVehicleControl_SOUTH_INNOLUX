...
namespace ObjectConverter_AGVC_NORTH_INNOLUX
{
    ...
    {
        private readonly string ns = "ObjectConverter_AGVC_NORTH_INNOLUX" + ".AVehicle";
        ...
        public bool SetVVEHICLE(ref ViewerObject.VVEHICLE vh, AVEHICLE avh, out string result)
        {
            ...
            try
            {
                ...
                vh.IS_PAUSE_SAFETY_DOOR = avh.SAFETY_DOOR_PAUSE == VhStopSingle.StopSingleOn;
                ...
                vh.TRANSFER_ID_1 = avh.MCS_CMD;
                _doing = "CMD_ID_1";
                vh.CMD_ID_1 = avh.OHTC_CMD;
                _doing = "CURRENT_EXCUTE_CMD_ID";
                vh.CURRENT_EXCUTE_CMD_ID = avh.OHTC_CMD;
                _doing = "CMD_TYPE";
                vh.CMD_TYPE = defCvt.GetCmdType(avh.CmdType);

                _doing = "SetCST";
                vh.SetCST(avh.HAS_CST == 1, avh.CST_ID);
