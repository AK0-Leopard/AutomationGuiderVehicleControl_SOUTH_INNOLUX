...
using ObjectConverter_AGVC_NORTH_INNOLUX;
using ViewerObject;
                ...
                using (DBConnection_EF con = DBConnection_EF.GetUContext())
                {
                    ...
                    var query = from cmd in (
                                ...
                                select new
                                {
                                    ...
                                    CompletedCount = g.Sum(i => (i.OHTC_COMPLETE_STATUS == (int)(int)CompleteStatus.CmpStatusUnload || i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.CmpStatusLoadunload) ? (Int32)1 : 0),
                                    ...
                                    MaxTransExecTime = (g.Max(i => (i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.CmpStatusUnload || i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.CmpStatusLoadunload) ? (DbFunctions.DiffSeconds(i.MCS_CMD_START_TIME, i.MCS_CMD_FINISH_TIME)) : 0) ?? 0),
                ...
                using (DBConnection_EF con = DBConnection_EF.GetUContext())
                {
                    ...
                    var query = from cmd in (from sbTable in con.VHCMD_OHTC_MCS.AsNoTracking()
                                ...
                                select new
                                {
                                    ...
                                    MaxCycleTime = (g.Max(i => (i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.CmpStatusUnload || i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.CmpStatusLoadunload) ? (DbFunctions.DiffSeconds(i.MCS_CMD_START_TIME, i.MCS_CMD_FINISH_TIME)) : 0) ?? 0),
