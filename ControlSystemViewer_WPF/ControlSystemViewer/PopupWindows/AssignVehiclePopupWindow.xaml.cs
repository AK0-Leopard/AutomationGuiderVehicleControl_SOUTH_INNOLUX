...
{
    /// <summary>
    /// AssignVehiclePopupWindow.xaml 的互動邏輯
    /// </summary>
    public partial class AssignVehiclePopupWindow : Window
    {
        #region 公用參數設定
        ...
        public AssignVehiclePopupWindow(VTRANSFER _cmd, object _caller = null)
        {
            InitializeComponent();
        ...
        private void _Load(object sender, EventArgs e)
        {
            try
            {
                TransferCommand.SetTitleName(this.Title, $"Assign Vehicle ID");
                TransferCommand.InitUI(cmd, BCAppConstants.SubPageIdentifier.TRANSFER_ASSIGN_VEHICLE);
            }
            catch (Exception ex)
            {
