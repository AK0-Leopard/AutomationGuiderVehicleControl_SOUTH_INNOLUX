...
{
    /// <summary>
    /// ChangeStatusPopupWindow.xaml 的互動邏輯
    /// </summary>
    public partial class ChangeStatusPopupWindow : Window
    {
        #region 公用參數設定
        ...
        public ChangeStatusPopupWindow(VTRANSFER _cmd, object _caller = null)
        {
            InitializeComponent();
        ...
        private void _Load(object sender, EventArgs e)
        {
            try
            {
                TransferCommand.SetTitleName(this.Title, $"Status");
                TransferCommand.InitUI(cmd, BCAppConstants.SubPageIdentifier.TRANSFER_CHANGE_STATUS);
            }
            catch (Exception ex)
            {
