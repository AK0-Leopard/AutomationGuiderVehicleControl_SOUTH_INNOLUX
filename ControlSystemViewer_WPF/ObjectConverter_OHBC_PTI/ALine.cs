...
namespace ObjectConverter_OHBC_PTI
{
    ...
    {
        private readonly string ns = "ObjectConverter_OHBC_PTI" + ".ALine";
        ...
        public bool SetVLINE(ref ViewerObject.VLINE line, ALINE aline, out string result)
        {
            ...
            try
            {
                ...
                allVehiclesConnectStatus.Add(aline.OHT1ConnectionSuccess);
                allVehiclesConnectStatus.Add(aline.OHT2ConnectionSuccess);
                allVehiclesConnectStatus.Add(aline.OHT3ConnectionSuccess);
                allVehiclesConnectStatus.Add(aline.OHT4ConnectionSuccess);
                allVehiclesConnectStatus.Add(aline.OHT5ConnectionSuccess);
                allVehiclesConnectStatus.Add(aline.OHT6ConnectionSuccess);
                allVehiclesConnectStatus.Add(aline.OHT7ConnectionSuccess);
                allVehiclesConnectStatus.Add(aline.OHT8ConnectionSuccess);
                allVehiclesConnectStatus.Add(aline.OHT9ConnectionSuccess);
                allVehiclesConnectStatus.Add(aline.OHT10ConnectionSuccess);
                allVehiclesConnectStatus.Add(aline.OHT11ConnectionSuccess);
                allVehiclesConnectStatus.Add(aline.OHT12ConnectionSuccess);
                allVehiclesConnectStatus.Add(aline.OHT13ConnectionSuccess);
                allVehiclesConnectStatus.Add(aline.OHT14ConnectionSuccess);
