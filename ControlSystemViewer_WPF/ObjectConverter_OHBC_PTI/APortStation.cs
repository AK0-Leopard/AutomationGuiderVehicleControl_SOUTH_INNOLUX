...
namespace ObjectConverter_OHBC_PTI
{
    ...
    {
        private readonly string ns = "ObjectConverter_OHBC_PTI" + ".APortStation";
        ...
        public bool SetVPORTSTATION(APORTSTATION aport, out ViewerObject.VPORTSTATION port, out string result)
        {
            ...
            try
            {
                ...
                port.IS_IN_SERVICE = aport.PORT_SERVICE_STATUS == E_PORT_STATUS.InService;  /*aport.PORT_SERVICE_STATUS == (int)PortStationServiceStatus.InService;*/
