...
namespace ObjectConverter_OHBC_PTI
{
    ...
    {
        private readonly string ns = "ObjectConverter_OHBC_PTI" + ".ASegment";
        ...
        public bool SetVSEGMENT(ASEGMENT aseg, out ViewerObject.VSEGMENT seg, out string result)
        {
            ...
            try
            {
                _doing = $"new ViewerObject.VSEGMENT({aseg.SEG_NUM}, {aseg.STATUS == E_SEG_STATUS.Closed})";
                seg = new ViewerObject.VSEGMENT(aseg.SEG_NUM, aseg.STATUS == E_SEG_STATUS.Closed);
