...
namespace ObjectConverter_OHTC_ASE
{
    public static class VehicleInfo
    {
        ...
        private static ViewerObject.VVEHICLE_Def.CommandType getCmdType(CommandType commandType)
        {
            switch (commandType)
            {
                case CommandType.CmdOverride:
                    return ViewerObject.VVEHICLE_Def.CommandType.Override;
                case CommandType.CmdHome:
                    return ViewerObject.VVEHICLE_Def.CommandType.Home;
                case CommandType.CmdRound:
                    return ViewerObject.VVEHICLE_Def.CommandType.Round;
                case CommandType.CmdContinue:
                    return ViewerObject.VVEHICLE_Def.CommandType.Continue;
                case CommandType.CmdTeaching:
                    return ViewerObject.VVEHICLE_Def.CommandType.Teaching;
                case CommandType.CmdLoadUnload:
                    return ViewerObject.VVEHICLE_Def.CommandType.LoadUnload;
                case CommandType.CmdUnload:
                    return ViewerObject.VVEHICLE_Def.CommandType.Unload;
                case CommandType.CmdLoad:
                    return ViewerObject.VVEHICLE_Def.CommandType.Load;
                case CommandType.CmdMoveMtport:
                    return ViewerObject.VVEHICLE_Def.CommandType.MoveMtport;
                case CommandType.CmdMovePark:
                    return ViewerObject.VVEHICLE_Def.CommandType.MovePark;
                case CommandType.CmdMove:
                default:
                    return ViewerObject.VVEHICLE_Def.CommandType.Move;
            }
        }
    }
