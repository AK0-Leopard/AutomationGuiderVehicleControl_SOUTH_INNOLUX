...
namespace ObjectConverter_OHTC_AT_S
{
    ...
    {
        private readonly string ns = "ObjectConverter_OHTC_AT_S" + ".VehicleInfo";
        ...
        public bool SetVVEHICLE(ref ViewerObject.VVEHICLE vh, object vh_info_obj, out string result)
        {
            ...
            try
            {
                ...
                //_doing = "SetPosition";
                //vh.SetPosition(vh_info.ax, vh_info.AxisY);
                ...
                _doing = "SetCST";
                vh.SetCST(vh_info.HasCstL == (int)VhLoadCarrierStatus.Exist, vh_info.CstIdL, vh_info.HasCstR == (int)VhLoadCarrierStatus.Exist, vh_info.CstIdR);
