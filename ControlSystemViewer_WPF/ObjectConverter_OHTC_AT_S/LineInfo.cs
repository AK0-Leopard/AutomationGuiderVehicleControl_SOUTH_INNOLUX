...
namespace ObjectConverter_OHTC_AT_S
{
    public class LineInfo : ILineInfo
    {
        private readonly string ns = "ObjectConverter_OHTC_AT_S" + ".LineInfo";
        ...
        public bool SetVLINE_by_PING_CHECK_INFO(ref ViewerObject.VLINE line, byte[] bytes, out string result)
        {
            ...
            try
            {
                ...
                allVehiclesConnectStatus.Add(info.OHT1ConnectionSuccess);
                allVehiclesConnectStatus.Add(info.OHT2ConnectionSuccess);
                allVehiclesConnectStatus.Add(info.OHT3ConnectionSuccess);
                allVehiclesConnectStatus.Add(info.OHT4ConnectionSuccess);
                allVehiclesConnectStatus.Add(info.OHT5ConnectionSuccess);
                allVehiclesConnectStatus.Add(info.OHT6ConnectionSuccess);
                allVehiclesConnectStatus.Add(info.OHT7ConnectionSuccess);
                allVehiclesConnectStatus.Add(info.OHT8ConnectionSuccess);
                allVehiclesConnectStatus.Add(info.OHT9ConnectionSuccess);
                allVehiclesConnectStatus.Add(info.OHT10ConnectionSuccess);
                allVehiclesConnectStatus.Add(info.OHT11ConnectionSuccess);
                allVehiclesConnectStatus.Add(info.OHT12ConnectionSuccess);
                allVehiclesConnectStatus.Add(info.OHT13ConnectionSuccess);
                allVehiclesConnectStatus.Add(info.OHT14ConnectionSuccess);
