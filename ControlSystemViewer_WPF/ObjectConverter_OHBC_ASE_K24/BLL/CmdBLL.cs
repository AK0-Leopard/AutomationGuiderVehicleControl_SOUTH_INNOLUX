    ...
    public class CmdBLL : ICmdBLL
    {
        ...
        private List<VACMD_MCS> loadUnfinishedTransfers()
        {
            using (DBConnection_EF con = DBConnection_EF.GetUContext())
            {
                ...
                var query = from cmd in con.VACMD_MCS.AsNoTracking()
                            where cmd.TRANSFERSTATE >= (int)E_TRAN_STATUS.Queue && cmd.TRANSFERSTATE <= (int)E_TRAN_STATUS.Aborting
        ...
        public int GetTransferMinPrioritySum()
        {
            using (DBConnection_EF con = DBConnection_EF.GetUContext())
            {
                ...
                var query = from cmd in con.VACMD_MCS.AsNoTracking()
                            where cmd.TRANSFERSTATE == (int)E_TRAN_STATUS.Queue
                    ...
                    var query = from sbTable in con.VHCMD_OHTC_MCS.AsNoTracking()
                                ...
                                &&
                                 (sbTable.OHTC_COMPLETE_STATUS == CompleteStatus.CmpStatusUnload ||         //normal end
                                                   ...
                                                   sbTable.OHTC_COMPLETE_STATUS == CompleteStatus.CmpStatusIdemptyRetrival || //emptyretrival
                                                   sbTable.OHTC_COMPLETE_STATUS == CompleteStatus.CmpStatusIddoubleStorage || //doublestorage
                                                   ...
                                                   sbTable.OHTC_COMPLETE_STATUS == CompleteStatus.CmpStatusScan ||            //scan    
                ...
                using (DBConnection_EF con = DBConnection_EF.GetUContext())
                {
                    ...
                    var query = from cmd in (
                                ...
                                select new
                                {
                                    ...
                                    EmptyRetrieval = g.Sum(i => i.OHTC_COMPLETE_STATUS == CompleteStatus.CmpStatusIdemptyRetrival ? (Int32)1 : 0),
                                    DoubleStorage = g.Sum(i => i.OHTC_COMPLETE_STATUS == CompleteStatus.CmpStatusIddoubleStorage ? (Int32)1 : 0),
                                    ...
                                    ScanCount = g.Sum(i => (i.OHTC_COMPLETE_STATUS == CompleteStatus.CmpStatusScan ? (Int32)1 : 0)),
                                    ...
                                    MaxTransExecTime = (int)(g.Max(i => (i.OHTC_COMPLETE_STATUS == CompleteStatus.CmpStatusUnload || i.OHTC_COMPLETE_STATUS == CompleteStatus.CmpStatusLoadunload) ? (DbFunctions.DiffSeconds(i.MCS_CMD_START_TIME, i.MCS_CMD_FINISH_TIME)) : 0) ?? 0),
                ...
                using (DBConnection_EF con = DBConnection_EF.GetUContext())
                {
                    ...
                    var query = from cmd in (from sbTable in con.VHCMD_OHTC_MCS.AsNoTracking()
                                ...
                                select new
                                {
                                    ...
                                    MaxCycleTime = (int)(g.Max(i => (i.OHTC_COMPLETE_STATUS == CompleteStatus.CmpStatusUnload || i.OHTC_COMPLETE_STATUS == CompleteStatus.CmpStatusLoadunload) ? (DbFunctions.DiffSeconds(i.MCS_CMD_START_TIME, i.MCS_CMD_FINISH_TIME)) : 0) ?? 0),
