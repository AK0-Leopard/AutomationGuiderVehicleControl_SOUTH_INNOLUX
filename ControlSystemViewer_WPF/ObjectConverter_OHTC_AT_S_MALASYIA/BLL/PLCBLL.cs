        ...
        private VHIDINFO GetVHidinfo( com.mirle.ibg3k0.sc.HIDINFO hIDINFO)
        {
            ...
            try
            {
                vHIDINFO = new VHIDINFO()
                {
                    ...
                    Hour_Negative_Converted = hIDINFO.Hour_Negative_Converted,
                    Hour_Positive_Converted = hIDINFO.Hour_Positive_Converted,
                    Hour_Sigma_Converted = hIDINFO.Hour_Sigma_Converted,
                    Sigma_W_Converted = hIDINFO.Sigma_W_Converted,
