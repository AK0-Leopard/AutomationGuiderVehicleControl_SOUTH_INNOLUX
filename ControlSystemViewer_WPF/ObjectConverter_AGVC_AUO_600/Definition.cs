...
namespace ObjectConverter_AGVC_AUO_600
{
    public class Definition : IDefinition
    {
        public class Convert
        {
            ...
            public E_CMD_TYPE GetE_CMD_TYPEInt(int cmdType)
            {
                switch (cmdType)
                {
                    case (int)ViewerObject.VCMD_Def.CmdType.Override:
                        return E_CMD_TYPE.Override;
                    case (int)ViewerObject.VCMD_Def.CmdType.MTLHome:
                        return E_CMD_TYPE.MTLHome;
                    case (int)ViewerObject.VCMD_Def.CmdType.Home:
                        return E_CMD_TYPE.Home;
                    case (int)ViewerObject.VCMD_Def.CmdType.Round:
                        return E_CMD_TYPE.Round;
                    case (int)ViewerObject.VCMD_Def.CmdType.Continue:
                        return E_CMD_TYPE.Continue;
                    case (int)ViewerObject.VCMD_Def.CmdType.Teaching:
                        return E_CMD_TYPE.Teaching;
                    case (int)ViewerObject.VCMD_Def.CmdType.LoadUnload:
                        return E_CMD_TYPE.LoadUnload;
                    case (int)ViewerObject.VCMD_Def.CmdType.Unload:
                        return E_CMD_TYPE.Unload;
                    case (int)ViewerObject.VCMD_Def.CmdType.Load:
                        return E_CMD_TYPE.Load;
                    case (int)ViewerObject.VCMD_Def.CmdType.MoveTeaching:
                        return E_CMD_TYPE.Move_Teaching;
                    case (int)ViewerObject.VCMD_Def.CmdType.MoveCharger:
                        return E_CMD_TYPE.Move_Charger;
                    case (int)ViewerObject.VCMD_Def.CmdType.MovePark:
                        return E_CMD_TYPE.Move_Park;
                    case (int)ViewerObject.VCMD_Def.CmdType.Move:
                    default:
                        return E_CMD_TYPE.Move;
                }
            }
            ...
            public ViewerObject.VCMD_Def.OHTCCompleteStatus? GetOHTCCompleteStatus(int? input)
            {
                switch (input)
                {
                    ...
                    case (int)CompleteStatus.CmpStatusCommandInitailFail:
