...
namespace ObjectConverter_AGVC_AUO_600
{
    ...
    {
        private readonly string ns = "ObjectConverter_AGVC_AUO_600" + ".ASegment";
        ...
        public bool SetVSEGMENT(ASEGMENT aseg, out ViewerObject.VSEGMENT seg, out string result)
        {
            ...
            try
            {
                _doing = $"new ViewerObject.VSEGMENT({aseg.SEG_ID}, {aseg.STATUS == E_SEG_STATUS.Closed})";
                seg = new ViewerObject.VSEGMENT(aseg.SEG_ID, aseg.STATUS == E_SEG_STATUS.Closed);
