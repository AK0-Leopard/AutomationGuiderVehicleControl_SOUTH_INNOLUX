...
namespace ObjectConverter_AGVC_ASE_K21
{
    public class VehicleInfo : IVehicleInfo
    {
        private readonly string ns = "ObjectConverter_AGVC_ASE_K21" + ".VehicleInfo";
        ...
        public string GetCmdID(object vh_info_obj) => ((VEHICLE_INFO)vh_info_obj)?.CmdID1 ?? "";
        public string GetCstID(object vh_info_obj) => ((VEHICLE_INFO)vh_info_obj)?.CstIdL ?? "";
        ...
        public bool SetVVEHICLE(ref ViewerObject.VVEHICLE vh, object vh_info_obj, out string result)
        {
            ...
            try
            {
                ...
                _doing = "HAS_ERROR";
                vh.HAS_ERROR = vh_info.ERROR == VhStopSingle.On;


                _doing = "IS_PAUSE_BLOCK";
                vh.IS_PAUSE_BLOCK = vh_info.BLOCKPAUSE == VhStopSingle.On;
                _doing = "IS_PAUSE_HID";
                vh.IS_PAUSE_HID = vh_info.HIDPAUSE == VhStopSingle.On;
                _doing = "IS_PAUSE_OBS";
                vh.IS_PAUSE_OBS = vh_info.OBSPAUSE == VhStopSingle.On;
                _doing = "IS_PAUSE_EARTHQUAKE";
                vh.IS_PAUSE_EARTHQUAKE = vh_info.EARTHQUAKEPAUSE == VhStopSingle.On;
                _doing = "IS_PAUSE_SAFETY_DOOR";
                vh.IS_PAUSE_SAFETY_DOOR = vh_info.SAFETYDOORPAUSE == VhStopSingle.On;

                _doing = "SetLocation";
                vh.SetLocation(vh_info.CURADRID, vh_info.CURSECID, vh_info.ACCSECDIST);
                //_doing = "SetPosition";
                //vh.SetPosition(vh_info.AxisX, vh_info.AxisY);

                _doing = "TRANSFER_ID_1";
                vh.TRANSFER_ID_1 = vh_info.TransferCmdID1;
                _doing = "TRANSFER_ID_2";
                vh.TRANSFER_ID_2 = vh_info.TransferCmdID2;
                _doing = "TRANSFER_ID_3";
                vh.TRANSFER_ID_3 = vh_info.TransferCmdID3;
                _doing = "TRANSFER_ID_4";
                vh.TRANSFER_ID_4 = vh_info.TransferCmdID4;
                _doing = "CMD_ID_1";
                vh.CMD_ID_1 = vh_info.CmdID1;
                _doing = "CMD_ID_2";
                vh.CMD_ID_2 = vh_info.CmdID2;
                _doing = "CMD_ID_3";
                vh.CMD_ID_3 = vh_info.CmdID3;
                _doing = "CMD_ID_4";
                vh.CMD_ID_4 = vh_info.CmdID4;
                //_doing = "CURRENT_EXCUTE_CMD_ID";
                //vh.CURRENT_EXCUTE_CMD_ID = vh_info.CmdID1;
                _doing = "CMD_TYPE";
                vh.CMD_TYPE = defCvt.GetCmdType(vh_info.CmdType);

                _doing = "SetCST";
                vh.SetCST(vh_info.HasCstL == VhLoadCSTStatus.Exist, vh_info.CstIdL, vh_info.HasCstR == VhLoadCSTStatus.Exist, vh_info.CstIdR);

                //_doing = "SetPath";
                //vh.SetPath(vh_info.StartAdr, vh_info.FromAdr, vh_info.ToAdr,
                //            vh_info.PredictPath?.ToList(), vh_info.WillPassSectionID?.ToList(), vh_info.ReservedSectionID?.ToList());

                _doing = "SPEED";
                vh.SPEED = vh_info.Speed;

                //_doing = "BatteryTemperature";
                //vh.BatteryTemperature = vh_info.BatteryTemperature;
                _doing = "BatteryCapacity";
                vh.BATTERY_CAPACITY = (int)vh_info.BatteryCapacity;
                _doing = "BatteryLevel";
                //vh.BATTERY_LEVEL = vh_info.BatteryLevel; // not given
                vh.BATTERY_LEVEL = ViewerObject.VVEHICLE_Def.GetBatteryLevel(vh.BATTERY_CAPACITY);
