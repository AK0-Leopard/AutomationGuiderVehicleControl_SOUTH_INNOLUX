...
namespace ObjectConverter_AGVC_ASE_K21
{
    ...
    {
        private readonly string ns = "ObjectConverter_AGVC_ASE_K21" + ".AVehicle";
        ...
        public bool SetVVEHICLE(ref ViewerObject.VVEHICLE vh, AVEHICLE avh, out string result)
        {
            ...
            try
            {
                ...
                _doing = "HAS_ERROR";
                vh.HAS_ERROR = avh.ERROR == VhStopSingle.On;


                _doing = "IS_PAUSE_BLOCK";
                vh.IS_PAUSE_BLOCK = avh.BLOCK_PAUSE == VhStopSingle.On;
                _doing = "IS_PAUSE_HID";
                vh.IS_PAUSE_HID = avh.HID_PAUSE == VhStopSingle.On;
                _doing = "IS_PAUSE_OBS";
                vh.IS_PAUSE_OBS = avh.OBS_PAUSE == VhStopSingle.On;
                _doing = "IS_PAUSE_EARTHQUAKE";
                vh.IS_PAUSE_EARTHQUAKE = avh.EARTHQUAKE_PAUSE == VhStopSingle.On;
                _doing = "IS_PAUSE_SAFETY_DOOR";
                vh.IS_PAUSE_SAFETY_DOOR = avh.SAFETY_DOOR_PAUSE == VhStopSingle.On;
                ...
                vh.TRANSFER_ID_1 = avh.TRANSFER_ID_1;
                _doing = "TRANSFER_ID_2";
                vh.TRANSFER_ID_2 = avh.TRANSFER_ID_2;
                _doing = "TRANSFER_ID_3";
                vh.TRANSFER_ID_3 = avh.TRANSFER_ID_3;
                _doing = "TRANSFER_ID_4";
                vh.TRANSFER_ID_4 = avh.TRANSFER_ID_4;
                _doing = "CMD_ID_1";
                vh.CMD_ID_1 = avh.CMD_ID_1;
                _doing = "CMD_ID_2";
                vh.CMD_ID_2 = avh.CMD_ID_2;
                _doing = "CMD_ID_3";
                vh.CMD_ID_3 = avh.CMD_ID_3;
                _doing = "CMD_ID_4";
                vh.CMD_ID_4 = avh.CMD_ID_4;
                ...
                _doing = "SetCST";
                vh.SetCST(avh.HAS_CST_L, avh.CST_ID_L, avh.HAS_CST_R, avh.CST_ID_R);

                //_doing = "SetPath";
                //vh.SetPath(avh.StartAdr, avh.FromAdr, avh.ToAdr,
                //            avh.PredictSections?.ToList(), avh.WillPassSectionID?.ToList(), avh.ReservedSectionID?.ToList());

                _doing = "SPEED";
                vh.SPEED = avh.Speed;

                //_doing = "BatteryTemperature";
                //vh.BatteryTemperature = avh.BatteryTemperature;
                _doing = "BatteryCapacity";
                vh.BATTERY_CAPACITY = (int)avh.BatteryCapacity;
                _doing = "BatteryLevel";
                //vh.BATTERY_LEVEL = avh.BatteryLevel; // not given
