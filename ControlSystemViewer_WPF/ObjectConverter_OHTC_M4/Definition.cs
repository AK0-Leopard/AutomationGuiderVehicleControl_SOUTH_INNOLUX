...
namespace ObjectConverter_OHTC_M4
{
    public class Definition : IDefinition
    {
        public class Convert
        {
            ...
            public VHModeStatus GetVHModeStatus(ViewerObject.VVEHICLE_Def.ModeStatus modeStatus)
            {
                switch (modeStatus)
                {
                    case ViewerObject.VVEHICLE_Def.ModeStatus.AutoMtl:
                        return VHModeStatus.AutoMtl;
                    case ViewerObject.VVEHICLE_Def.ModeStatus.AutoMts:
                        return VHModeStatus.AutoMts;
            ...
            public ViewerObject.VCMD_Def.CmdType GetCmdType(E_CMD_TYPE cmd_type)
            {
                switch (cmd_type)
                {
                    ...
                    case E_CMD_TYPE.Move_Charger:
                        return ViewerObject.VCMD_Def.CmdType.MoveCharger;
                    case E_CMD_TYPE.Move:
                        return ViewerObject.VCMD_Def.CmdType.Move;
                    case E_CMD_TYPE.Move_MTL:
                        return ViewerObject.VCMD_Def.CmdType.Move_MTL;
                    case E_CMD_TYPE.SystemIn:
                        return ViewerObject.VCMD_Def.CmdType.SystemIn;
                    case E_CMD_TYPE.SystemOut:
                        return ViewerObject.VCMD_Def.CmdType.SystemOut;
                    default:
            ...
            public PauseType GetPauseType(ViewerObject.VVEHICLE_Def.VPauseType pauseType)
            {
                switch (pauseType)
                {
                    ...
                    case ViewerObject.VVEHICLE_Def.VPauseType.Hid:
                        return PauseType.Hid;
                    case ViewerObject.VVEHICLE_Def.VPauseType.ManualBlock:
                        return PauseType.ManualBlock;
                    case ViewerObject.VVEHICLE_Def.VPauseType.ManualHid:
            ...
            public ViewerObject.VCMD_Def.OHTCCompleteStatus? GetOHTCCompleteStatus(CompleteStatus? input)
            {
                switch (input)
                {
                    ...
                    case CompleteStatus.CmpStatusScan:
                        return ViewerObject.VCMD_Def.OHTCCompleteStatus.CmpStatusScan;
                    case CompleteStatus.CmpStatusMoveToMtl:
                        return ViewerObject.VCMD_Def.OHTCCompleteStatus.CmpStatusMoveToMtl;
                    ...
                    case CompleteStatus.CmpStatusIdreadDuplicate:
                        return ViewerObject.VCMD_Def.OHTCCompleteStatus.CmpStatusIdreadDuplicate;
                    case CompleteStatus.CmpStatusIddoubleStorage:
                        return ViewerObject.VCMD_Def.OHTCCompleteStatus.CmpStatusIddoubleStorage;
                    case CompleteStatus.CmpStatusIdemptyRetrival:
                        return ViewerObject.VCMD_Def.OHTCCompleteStatus.CmpStatusIdemptyRetrival;
                    case CompleteStatus.CmpStatusIdcsttypeMismatch:
                        return ViewerObject.VCMD_Def.OHTCCompleteStatus.CmpStatusIdcsttypeMismatch;
            ...
            public ViewerObject.VCMD_Def.OHTCCompleteStatus? GetOHTCCompleteStatusInt(int? input)
            {
                switch (input)
                {
                    case (int)CompleteStatus.CmpStatusMove:
                        return ViewerObject.VCMD_Def.OHTCCompleteStatus.CmpStatusMove;
                    case (int)CompleteStatus.CmpStatusLoad:
                        return ViewerObject.VCMD_Def.OHTCCompleteStatus.CmpStatusLoad;
                    case (int)CompleteStatus.CmpStatusUnload:
                        return ViewerObject.VCMD_Def.OHTCCompleteStatus.CmpStatusUnload;
                    case (int)CompleteStatus.CmpStatusLoadunload:
                        return ViewerObject.VCMD_Def.OHTCCompleteStatus.CmpStatusLoadunload;
                    case (int)CompleteStatus.CmpStatusHome:
                        return ViewerObject.VCMD_Def.OHTCCompleteStatus.CmpStatusHome;
                    case (int)CompleteStatus.CmpStatusOverride:
                        return ViewerObject.VCMD_Def.OHTCCompleteStatus.CmpStatusOverride;
                    case (int)CompleteStatus.CmpStatusCstIdrenmae:
                        return ViewerObject.VCMD_Def.OHTCCompleteStatus.CmpStatusCstIdrenmae;
                    case (int)CompleteStatus.CmpStatusMtlhome:
                        return ViewerObject.VCMD_Def.OHTCCompleteStatus.CmpStatusMtlhome;
                    case (int)CompleteStatus.CmpStatusScan:
                        return ViewerObject.VCMD_Def.OHTCCompleteStatus.CmpStatusScan;
                    case (int)CompleteStatus.CmpStatusMoveToMtl:
                        return ViewerObject.VCMD_Def.OHTCCompleteStatus.CmpStatusMoveToMtl;
                    case (int)CompleteStatus.CmpStatusSystemOut:
                        return ViewerObject.VCMD_Def.OHTCCompleteStatus.CmpStatusSystemOut;
                    case (int)CompleteStatus.CmpStatusSystemIn:
                        return ViewerObject.VCMD_Def.OHTCCompleteStatus.CmpStatusSystemIn;
                    case (int)CompleteStatus.CmpStatusTechingMove:
                        return ViewerObject.VCMD_Def.OHTCCompleteStatus.CmpStatusTechingMove;
                    ...
                    case (int)CompleteStatus.CmpStatusIdreadFailed:
                        return ViewerObject.VCMD_Def.OHTCCompleteStatus.CmpStatusIdreadFailed;
                    case (int)CompleteStatus.CmpStatusIdreadDuplicate:
                        return ViewerObject.VCMD_Def.OHTCCompleteStatus.CmpStatusIdreadDuplicate;
                    case (int)CompleteStatus.CmpStatusIddoubleStorage:
                        return ViewerObject.VCMD_Def.OHTCCompleteStatus.CmpStatusIddoubleStorage;
                    case (int)CompleteStatus.CmpStatusIdemptyRetrival:
                        return ViewerObject.VCMD_Def.OHTCCompleteStatus.CmpStatusIdemptyRetrival;
                    case (int)CompleteStatus.CmpStatusIdcsttypeMismatch:
                        return ViewerObject.VCMD_Def.OHTCCompleteStatus.CmpStatusIdcsttypeMismatch;
