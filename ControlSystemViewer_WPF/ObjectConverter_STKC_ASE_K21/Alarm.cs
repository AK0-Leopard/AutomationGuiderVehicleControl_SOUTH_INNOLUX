...
namespace ObjectConverter_STKC_ASE_K21
{
    ...
    {
        private readonly string ns = "ObjectConverter_STKC_ASE_K21" + ".Alarm";
        ...
        public bool SetVALARM(AlarmViewExtension alarm, out ViewerObject.VALARM valarm, out string result)
        {
            string ms = System.Reflection.MethodBase.GetCurrentMethod().Name;
            result = "";
            valarm = null;
            ...
            try
            {
                ...
                valarm.RPT_DATE_TIME = alarm.RPT_DATE_TIME;
                _doing = $"Set EQPT_ID";
                valarm.EQPT_ID = alarm.EQPT_ID?.Trim() ?? "";
                _doing = $"Set ALARM_LVL";
                valarm.ALARM_LVL = new Definition.Convert().GetAlarmLevel((int)alarm.ALAM_LVL);
                ...
                valarm._RPT_DATE_TIME = Convert.ToDateTime(alarm.RPT_DATE_TIME);
                ...
                valarm.ALARM_MODULE = alarm.ALARM_MODULE.HasValue ? (int)alarm.ALARM_MODULE.Value : 0;
                return true;
            }
            catch
            {
        ...
        public ViewerObject.VALARM SetVALARM(AlarmViewExtension alarm)
        {
            ViewerObject.VALARM valarm = new ViewerObject.VALARM();
            valarm.EQPT_ID = alarm.EQPT_ID;
            valarm.ADDRESS_ID = alarm.ADDRESS_ID;
            valarm.ALARM_CODE = alarm.ALAM_CODE;
            valarm.ALARM_DESC = alarm.ALAM_DESC;
            valarm.ALARM_LVL = (ViewerObject.VALARM_Def.AlarmLvl)alarm.ALAM_LVL;
            valarm.ALARM_MODULE = Convert.ToInt32(alarm.ALARM_MODULE);
            valarm.ALARM_REMARK = alarm.REMARK;
            valarm.CARRIER_ID = alarm.CARRIER_ID;
            valarm.CLEAR_DATE_TIME = alarm.END_TIME.ToString();
            valarm.RPT_DATE_TIME = alarm.RPT_DATE_TIME;
            valarm._ALARM_CLASSIFICATION = Convert.ToInt32(alarm.CLASS);
