            ...
            try
            {
                using (DBConnection_EF con = DBConnection_EF.GetUContext())
                {
                    ...
                    foreach (var item in CMDquery?.ToList())
                    {
                        ...
                        oVErrorCMD.OHTC_CMD_STATUS = Define.DefineInt_To_EOHTC_CMD_STATUS((int)item.OHTC_CMD_STATUS);
            ...
            try
            {
                using (DBConnection_EF con = DBConnection_EF.GetUContext())
                {
                    ...
                    foreach (var item in CMDquery?.ToList())
                    {
                        ...
                        oVTimeOutCMD.OHTC_CMD_STATUS = Define.DefineInt_To_EOHTC_CMD_STATUS((int)item.OHTC_CMD_STATUS);
