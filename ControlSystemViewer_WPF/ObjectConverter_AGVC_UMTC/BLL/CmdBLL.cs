...
namespace ObjectConverter_AGVC_UMTC.BLL
{ 
            ...
            try
            {
                ...
                using (DBConnection_EF con = DBConnection_EF.GetUContext())
                {
                    ...
                    var query = from sbTable in con.VHCMD_OHTC_MCS.AsNoTracking()
                                ...
                                &&
                                 (sbTable.OHTC_COMPLETE_STATUS == (int)CompleteStatus.Unload ||         //normal end
                                                   sbTable.OHTC_COMPLETE_STATUS == (int)CompleteStatus.Loadunload ||
                                                   sbTable.OHTC_COMPLETE_STATUS == (int)CompleteStatus.InterlockError ||  //interlock
                                                   sbTable.OHTC_COMPLETE_STATUS == (int)CompleteStatus.VehicleAbort ||    //vehicleabort
                                                   sbTable.OHTC_COMPLETE_STATUS == (int)CompleteStatus.IdreadFailed       //barcoderead
                                                   ) &&
                    ...
                    foreach (var item in query?.ToList())
                    {
                        ...
                        VCMD_OHTC oVCMD_OHTC = new VCMD_OHTC()
                        {
                            ...
                            MCS_CMD_INSERTTIME = item.MCS_CMD_INSER_TIME??DateTime.MinValue,
                            ...
                            MCS_COMMANDSTATE = defCvt.GetCommandStateInt((int)item.MCS_COMMANDSTATE),
                            OHTC_CMD_START_TIME = item.OHTC_CMD_START_TIME,
                            OHTC_CMD_END_TIME = item.OHTC_CMD_END_TIME,
                            OHTC_COMPLETE_STATUS = defCvt.GetOHTCCompleteStatusInt(item.OHTC_COMPLETE_STATUS)
                        };
                ...
                using (DBConnection_EF con = DBConnection_EF.GetUContext())
                {
                    ...
                    var query = from cmd in subquery
                                ...
                                select new
                                {
                                    VH_ID = g.Key.VH_ID,
                                    CMDCount = g.Count(),
                                    EQPTAbortErrorCount = g.Sum(i => (i.OHTC_CMPSTATUS == (int)CompleteStatus.VehicleAbort) ? (Int32)1 : 0),
                                };
                ...
                using (DBConnection_EF con = DBConnection_EF.GetUContext())
                {
                    ...
                    var query = from cmd in (
                                ...
                                select new
                                {
                                    ...
                                    CompletedCount = g.Sum(i => (i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.Unload || i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.Loadunload) ? (Int32)1 : 0),
                                    EmptyRetrieval = 0,
                                    DoubleStorage = 0,
                                    InterLockCount = g.Sum(i => i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.InterlockError ? (Int32)1 : 0),
                                    EQPTAbortErrorCount = g.Sum(i => i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.VehicleAbort ? (Int32)1 : 0),
                                    ScanCount = 0,
                                    BarcodeReadFail = g.Sum(i => ((i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.IdreadFailed) ? (Int32)1 : 0)),

                                    LeadTime128 = g.Sum(i => (i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.Unload || i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.Loadunload) ? (DbFunctions.DiffSeconds(i.MCS_CMD_INSER_TIME, i.MCS_CMD_FINISH_TIME)) : 0) ?? 0,
                                    LeadTime128_5 = g.Sum(i => ((i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.Unload || i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.Loadunload) && i.OHTC_CMD_TYPE == 5) ? (DbFunctions.DiffSeconds(i.MCS_CMD_INSER_TIME, i.MCS_CMD_FINISH_TIME)) : 0) ?? 0,

                                    TransExecTime = g.Sum(i => (DbFunctions.DiffMinutes(i.MCS_CMD_START_TIME, i.MCS_CMD_FINISH_TIME))) ?? 0,
                                    TransExecTime128 = g.Sum(i => (i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.Unload || i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.Loadunload) ? (DbFunctions.DiffSeconds(i.MCS_CMD_START_TIME, i.MCS_CMD_FINISH_TIME)) : 0) ?? 0,
                                    TransExecTime128_5 = g.Sum(i => ((i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.Unload || i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.Loadunload) && i.OHTC_CMD_TYPE == 5) ? (DbFunctions.DiffSeconds(i.MCS_CMD_START_TIME, i.MCS_CMD_FINISH_TIME)) : 0) ?? 0,
                                    MaxTransExecTime = (int)(g.Max(i => (i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.Unload || i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.Loadunload) ? (DbFunctions.DiffSeconds(i.MCS_CMD_START_TIME, i.MCS_CMD_FINISH_TIME)) : 0) ?? 0),
                                    MinTransExecTime = (int?)(g.Min(i => ((i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.Unload || i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.Loadunload) && i.OHTC_CMD_TYPE == 5) ? (DbFunctions.DiffSeconds(i.MCS_CMD_START_TIME, i.MCS_CMD_FINISH_TIME)) : null) ?? null),

                                    LoadingInterLock = g.Sum(i => ((i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.InterlockError) && ((i.COMMANDSTATE & 4) == 4) && ((i.COMMANDSTATE & 32) != 32)) ? (int)1 : 0),
                                    UnLoadingInterLock = g.Sum(i => ((i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.InterlockError) && ((i.COMMANDSTATE & 32) == 32)) ? (int)1 : 0)
                                };
                ...
                using (DBConnection_EF con = DBConnection_EF.GetUContext())
                {
                    ...
                    var query = from cmd in (from sbTable in con.VHCMD_OHTC_MCS.AsNoTracking()
                                ...
                                select new
                                {
                                    ...
                                    CycleTime128 = g.Sum(i => (i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.Unload || i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.Loadunload) ? (DbFunctions.DiffSeconds(i.MCS_CMD_START_TIME, i.MCS_CMD_FINISH_TIME)) : 0) ?? 0,
                                    CycleTime128_5 = g.Sum(i => ((i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.Unload || i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.Loadunload) && i.OHTC_CMD_TYPE == 5) ? (DbFunctions.DiffSeconds(i.MCS_CMD_START_TIME, i.MCS_CMD_FINISH_TIME)) : 0) ?? 0,
                                    MaxCycleTime = (int)(g.Max(i => (i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.Unload || i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.Loadunload) ? (DbFunctions.DiffSeconds(i.MCS_CMD_START_TIME, i.MCS_CMD_FINISH_TIME)) : 0) ?? 0),
                                    MinCycleTime = (int?)(g.Min(i => ((i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.Unload || i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.Loadunload) && i.OHTC_CMD_TYPE == 5) ? (DbFunctions.DiffSeconds(i.MCS_CMD_START_TIME, i.MCS_CMD_FINISH_TIME)) : null) ?? null),

                                    LoadingInterLock = g.Sum(i => ((i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.InterlockError) && ((i.MCS_COMMANDSTATE & 4) == 4) && ((i.MCS_COMMANDSTATE & 32) != 32)) ? (int)1 : 0),
                                    UnLoadingInterLock = g.Sum(i => ((i.OHTC_COMPLETE_STATUS == (int)CompleteStatus.InterlockError) && ((i.MCS_COMMANDSTATE & 32) == 32)) ? (int)1 : 0)
                                };
            ...
            */
            ...
            try
            {
                ...
                using (DBConnection_EF con = DBConnection_EF.GetUContext())
                {
                    ...
                    var query1 = (from sbTable in con.HCMD.AsNoTracking()
            ...
            try
            {
                ...
                using (DBConnection_EF con = DBConnection_EF.GetUContext())
                {
                    ...
                    var query = (from sbTable in con.HCMD.AsNoTracking()
                                 select sbTable.VH_ID).Distinct().OrderBy(info => info);
